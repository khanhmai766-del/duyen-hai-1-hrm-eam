...
export async function GET(req: Request) {
  return permitHandle(async () => {
    ...
    sheet.addRow(["STT (KH/ĐX/SC)", "Số PCT", "Nội dung công việc", "Ngày thực hiện", "Người cấp PCT", "Người lãnh đạo công việc", "Người chỉ huy trực tiếp", "Đơn vị công tác", "Số nhân viên", "Người cho phép làm việc", "Kết quả công việc", "Ghi chú", "Tổ máy / vị trí", "Số SYC", "Loại đơn vị", "Hình thức phiếu"]);
