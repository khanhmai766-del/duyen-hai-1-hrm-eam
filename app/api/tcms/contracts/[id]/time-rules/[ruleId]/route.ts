...
import { parseContractTimeRuleInput, parseExpectedVersion } from "@/lib/tcms/server/contracts/contract-structure-service";
...
type Params = { params: { id: string; ruleId: string } };
