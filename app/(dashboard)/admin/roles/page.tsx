...
const DEFAULT_PERMISSIONS: PermissionRow[] = [
  ...
  },
  {
    ...
    note: "Trợ lý AI được đọc hướng dẫn quản lý vật tư và tờ trình quy trình vật tư VH1 khi trả lời. Không có quyền thì trợ lý không thấy nhóm tài liệu này.",
    matrix: { ADMIN: "read", MANAGER: "read", SUPERVISOR: "read", TECHNICIAN: "read", VIEWER: "none" },
  },
  {
    id: "ai-chat-tailieu-pccc",
    group: "Trợ lý AI",
    feature: "Tra cứu tài liệu: Sổ thiết bị PCCC",
    note: "Trợ lý AI được đọc tài liệu mô tả sổ theo dõi thiết bị PCCC trên web (không phải phương án chữa cháy chính thức).",
    matrix: { ADMIN: "read", MANAGER: "read", SUPERVISOR: "read", TECHNICIAN: "read", VIEWER: "none" },
  },
  {
    id: "ai-chat-tailieu-tbycnn",
    group: "Trợ lý AI",
    feature: "Tra cứu tài liệu: Sổ thiết bị TBYCNN",
    note: "Trợ lý AI được đọc tài liệu mô tả sổ thiết bị yêu cầu nghiêm ngặt về ATLĐ trên web.",
    matrix: { ADMIN: "read", MANAGER: "read", SUPERVISOR: "read", TECHNICIAN: "read", VIEWER: "none" },
  },
  {
    id: "ai-chat-tailieu-an-toan",
    group: "Trợ lý AI",
    feature: "Tra cứu tài liệu: Sổ cấp phiếu công tác",
    note: "Trợ lý AI được đọc tài liệu mô tả sổ cấp phiếu công tác trên web (không phải quy định an toàn lao động chính thức).",
    matrix: { ADMIN: "read", MANAGER: "read", SUPERVISOR: "read", TECHNICIAN: "read", VIEWER: "none" },
  },
  {
  ...
  {
    id: "erp-material-manage",
    group: "Vật tư",
    feature: "Vật tư theo ERP",
    note: "Cho phép hiện mục Vật tư theo ERP trên menu. Quyền Xem được tra cứu tồn kho và nhóm vật tư; quyền Quản lý/Toàn quyền được đồng bộ ERP, thêm, sửa, ngừng sử dụng, xoá và phân nhóm vật tư.",
  ...
  {
    id: "grounding-lightning-view",
    group: "Tiếp địa & chống sét",
    feature: "Xem danh mục và lịch sử kiểm tra",
    note: "Xem theo cương vị đang làm việc; Quản trị viên và các cương vị quản lý được xem toàn phân xưởng.",
    matrix: { ADMIN: "full", MANAGER: "read", SUPERVISOR: "read", TECHNICIAN: "read", VIEWER: "read" },
  },
  {
    id: "grounding-lightning-manage",
    group: "Tiếp địa & chống sét",
    feature: "Cập nhật kết quả, ảnh và ký xác nhận",
    note: "Từ mức Cá nhân được cập nhật và ký các dòng thuộc đúng cương vị đang làm việc; cấp quản lý được thao tác toàn phân xưởng.",
    matrix: { ADMIN: "full", MANAGER: "manage", SUPERVISOR: "manage", TECHNICIAN: "personal", VIEWER: "none" },
  },
  {
    id: "grounding-lightning-catalog",
    group: "Tiếp địa & chống sét",
    feature: "Thêm và sửa danh mục kiểm tra",
    note: "Quản lý thông tin khu vực/thiết bị và bổ sung điểm kiểm tra Chống sét, Tiếp địa hoặc cả hai; không bao gồm quyền xoá.",
    matrix: { ADMIN: "full", MANAGER: "manage", SUPERVISOR: "none", TECHNICIAN: "none", VIEWER: "none" },
  },
  {
    id: "grounding-lightning-delete",
    group: "Tiếp địa & chống sét",
    feature: "Xoá thiết bị hoặc điểm kiểm tra",
    note: "Quyền phá huỷ độc lập. Người có quyền thêm/sửa danh mục không tự động được xoá thiết bị, loại kiểm tra, lịch sử và ảnh liên quan. Mặc định chỉ Quản trị viên có quyền này.",
    matrix: { ADMIN: "full", MANAGER: "none", SUPERVISOR: "none", TECHNICIAN: "none", VIEWER: "none" },
  },
  {
    id: "tbycnn-view",
...
function mergeDefaultPermissions(rows: PermissionRow[]) {
  ...
  const legacyIds = new Set([
    ...
    "shift-check-in",
    "shift-approve",
    "shift-staffing-manage",
    "shift-schedule-view",
    "shift-schedule-generate",
    "shift-schedule-regenerate",
    "shift-schedule-lock",
