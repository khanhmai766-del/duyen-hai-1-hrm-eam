 ...
 *
 *   npx tsx scripts/data-ops/xuat-bbthvt-ton-dong.ts 1680/VH1 1682/VH1            # CHẠY KHÔ
 *   npx tsx scripts/data-ops/xuat-bbthvt-ton-dong.ts 1680/VH1 1682/VH1 --commit   # ghi thật
 *
 * ─── Vì sao cần script ───────────────────────────────────────────────────────
...
async function main() {
  if (!SO_PHIEU.length) {
    console.error("Thiếu số phiếu. Ví dụ:\n  npx tsx scripts/data-ops/xuat-bbthvt-ton-dong.ts 1680/VH1 1682/VH1 [--commit]");
    process.exit(1);
  }
