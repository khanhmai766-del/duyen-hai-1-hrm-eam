 ...
 *
 *   npx tsx scripts/data-ops/clone-replacement-declarations.ts --from "Dầu Shell Omala S2 GX220" --to "Dầu Sinopec L-CKD 220" --by khanhmdk@tpcduyenhai.com.vn
...
async function main() {
  if (!TEN_NGUON || !TEN_DICH || !EMAIL_NGUOI_TAO) {
    ...
    console.error('  npx tsx scripts/data-ops/clone-replacement-declarations.ts \\');
