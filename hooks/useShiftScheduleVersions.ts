...
export type ScheduleVersion = {
  ...
  generationWarnings: Array<{ date: string; positionId: string; shiftType: string; message: string }> | null;
...
export function useGenerateShiftSchedule() {
  ...
  return useMutation({
    ...
    onSuccess: () => client.invalidateQueries({ queryKey: ["shift-schedule-versions"] }),
  });
}
