  ...
  return <div className="space-y-5">
    ...
    <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="flex flex-col gap-3 border-b border-slate-200 p-4 lg:flex-row lg:items-center lg:justify-between">
        <div><h2 className="font-bold text-slate-900">Hiện có tại phân xưởng</h2><p className="text-sm text-slate-500">Mặc định ẩn vật tư hết tồn; nhập từ khóa để tra cứu. “Chung” được cấp cho người nhận, vật tư có cương vị chỉ ghi nhận sử dụng.</p></div>
