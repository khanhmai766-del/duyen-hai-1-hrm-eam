...
- Số tự động đi sau số lớn nhất từng lấy/cấp và mốc sổ giấy, kể cả số đã hủy; số đã hủy chỉ được cấp lại bằng nhập tay, xem hồ sơ cũ và xác nhận. Số đã cấp chỉ giải phóng khi hủy phiếu đúng vòng đời; phiếu cũ giữ nguyên lịch sử. API lưu phiếu mới yêu cầu lượt giữ hợp lệ và chuyển sang Đã cấp trong cùng giao dịch. Mốc sổ giấy được ADMIN thiết lập riêng theo loại/năm, có lý do và lịch sử; chưa thiết lập mốc thì không cấp số mới.
