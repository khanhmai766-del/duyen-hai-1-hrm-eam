...
import {
  ...
  PENDING_ERP_CODE_PREFIX,
  STANDALONE_GROUP_PREFIX,
  isGroupableCategory,
  isPendingErpCode,
  type GroupableCategory,
} from "@/lib/oil-grouping-shared";

// Phần thuần (hằng số, hàm không chạm DB) nằm ở `lib/oil-grouping-shared.ts` để màn hình
// trình duyệt dùng được mà không kéo theo Prisma. Xuất lại ở đây cho các route máy chủ
// đang import sẵn khỏi phải sửa đường dẫn.
export {
  GROUPABLE_CATEGORIES,
  STANDALONE_GROUP_PREFIX,
  PENDING_ERP_CODE_PREFIX,
...
export type { GroupableCategory } from "@/lib/oil-grouping-shared";
